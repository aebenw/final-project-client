      ...
      <div className="col-12-lg">
        ...
        <div id="feed" className="row">
          ...
          <ul>
            ...
            <li>
            The backend uses 'Shallow Serializers' to render nested data with more specific information. i.e - It makes it possible to see a user's friend's channel's block's image. Where as, by default, the serializer would give just the block's ID for a channel, if anything at all, rather than more specific information.</li>
            <li>
