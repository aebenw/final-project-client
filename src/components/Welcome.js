    ...
    return (
      <Fragment>
        ...
        <div className="row">
          ...
          <li>A block can belong to more than one channel. If you see a block on another user's channel that you think would work with a one you've created, you can add that block to your channel. </li>

          <li>You can see all of the channels you've created and followed on your profile as well as all your friends. </li>
        ...
        <h4>Tech Specs
          ...
          Fully functional AUTH using JWT tokens generated by the backend and saved to the front end in localstorage. Allowing a user to close the page and continue to be logged in. It also fetches the relevant information of the url you're trying to go to if you have access to it.
            i.e you can reload on a friend's page and if you're logged in it will render with a that friend's information.</h4>
      </div>
    </div>
      </Fragment>
    )
